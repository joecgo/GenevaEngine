...
namespace GenevaEngine
{
	...
	/*!
	 *  Processes the node in a recursive fashion. Processes each individual mesh
	...
	/*!
	 *  Processes the mesh from vertex and texture data
	 *
	 *      \param [in,out] mesh
	 *      \param [in]     scene
	 *
	...
	Mesh Model::processMesh(aiMesh* mesh, const aiScene* scene)
	{
		...
		for (unsigned int i = 0; i < mesh->mNumVertices; i++)
		{
			...
			// vector class that doesn't directly convert to gfailed to load at path:lm's
	 ...
	 *      \param [in]     typeName
	 *
	 *      \return returns a material as a vector of textures (TODO?: create a material class)
	 */
	...
	/*!
	 *  Create a texture from a file path and returns the id
	 *
	 *      \param [in] path
	 *      \param [in] directory
	 *      \param [in] gamma
	 *
	 *      \return an ID that is a handle for the texture
	 */
